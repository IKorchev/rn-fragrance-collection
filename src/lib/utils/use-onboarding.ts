  ...
  const steps: OnboardingStep[] = [
    {
      ...
      description: "Search the catalog or add one by hand.",
      done: hasCollection,
      enabled: true,
    },
    {
      ...
      description: "Tap Wear on a fragrance in your collection.",
      done: hasWorn,
    ...
    },
    {
      ...
      description: "Let the app choose what to wear today.",
      done: pickerTried,
      enabled: hasCollection,
    },
  ]
