...
Data is stored with [Supabase](https://supabase.com/privacy) (Postgres database and authentication), hosted in the EU (eu-west-1). Push notifications are delivered through [Expo's push service](https://expo.dev/privacy) and Apple/Google's notification services. Crash reports, if enabled, are processed by Sentry.

## Data retention and deletion

Your data is kept for as long as your account exists. You can delete your account at any time from **Profile → Delete account** — this permanently removes your account, collection, notes, individual ratings and votes, wear history, and push tokens. Deletion is immediate and cannot be undone.
...
Questions or data requests: **korchev94@gmail.com**
